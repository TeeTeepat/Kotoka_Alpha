...
export default function LanguageOnboardingPage() {
  ...
  const handleConfirm = async () => {
    ...
    setSaving(false);
    // Kids-only flow: language → name & avatar → age band. No adult fields, no CEFR test.
      ...
      <div className="flex flex-col items-center gap-4 mb-8">
        ...
        <div className="flex items-center gap-2">
          {[1, 2, 3].map((s) => (
            <motion.div
              key={s}
              animate={{ width: (step === s) || (s === 1 && step === 1) ? 24 : 8, backgroundColor: s <= step ? "#1ad3e2" : "#e2e8f0" }}
          ...
          {step === 1 ? (
            ...
            >
              <div className="text-center space-y-2">
                <p className="font-body text-gray-400 text-xs uppercase tracking-widest">Step 1 of 3 · Your language</p>
            ...
            >
              <div className="text-center space-y-2 w-full">
                <p className="font-body text-gray-400 text-xs uppercase tracking-widest">Step 2 of 3 · Target language</p>
                <div className="flex items-center justify-center gap-2 flex-wrap">
